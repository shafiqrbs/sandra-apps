...
class ColorSchema {
  // Colorschema list for poskeeper app
  ...
  Color primaryColor =  Color(0xFFF7DFBB);
  ...
  factory ColorSchema.fromJson(Map<String, dynamic> json) {
    ...
    return ColorSchema()
      ...
      //..formPrefixIconColor = parseColor(json['formPrefixIconColor'], Color(0xff7c7c80),)
      //..formSuffixIconColor = parseColor(json['formSuffixIconColor'], Color(0xff7c7c80),)
      //..formClearIconColor = parseColor(json['formClearIconColor'], Color(0xfffc1919),)
      //..formLabelColor = parseColor(json['formLabelColor'], const Color(0xFF716D64),)
      //..formExampleColor = parseColor(json['formExampleColor'], const Color(0xFF5A5750),)
      //..formErrorMsgColor = parseColor(json['formErrorMsgColor'], const Color(0xFFB2D4FF),)
      ..formSuccessMsgColor = parseColor(
        json['formSuccessMsgColor'],
        const Color(0xFF99C5FF),
      )
      //..formBaseHintTextColor = parseColor(json['formBaseHintTextColor'], const Color(0xFF66A9FF),)
      //..formBaseFillColor = parseColor(json['formBaseFillColor'], const Color(0xFFFFFFFF),)
      //..formBaseBorderColor = parseColor(json['formBaseBorderColor'], const Color(0xFF7FB7FF),)
      //..formBaseFontTextColor = parseColor(json['formBaseFontTextColor'], const Color(0xFF000000),)
      //..formFocusFillColor = parseColor(json['formFocusFillColor'], const Color(0xFFB2D4FF),)
      //..formFocusBorderColor = parseColor(json['formFocusBorderColor'], const Color(0xFFCCE2FF),)
      //..formFocusFontTextColor = parseColor(json['formFocusFontTextColor'], const Color(0xFFE5F0FF),)
      ...
      //..formCursorColor = parseColor(json['formCursorColor'], const Color(0xff000000),)
