...
class FBDatePicker extends StatelessWidget {
  //Strings
  String? label;
  String? example;
  String? hint;
  ...
  Widget build(BuildContext context) {
    return Obx(
      () {
        return Container(
          padding:
              padding ?? EdgeInsets.symmetric(vertical: 0.v, horizontal: 0.h),
          margin: EdgeInsets.symmetric(vertical: 0.v, horizontal: 0.h),
          child: Column(
            children: [
              label != null || example != null
                  ? Column(
                      children: [
                        Row(
                          ...
                          children: [
                            Flexible(
                              child: Text(
                                label ?? '',
                                style:
                                    labelTextStyle ?? FBTypography().tfLabelTS,
                              ),
                            ),
                            Flexible(
                              child: Text(
