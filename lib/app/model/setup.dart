import 'package:terminalbd/core/database_helper/db_helper.dart';
import 'package:terminalbd/core/database_helper/db_tables.dart';

class SetUp with DbTables {
  DbHelper databaseHelper = DbHelper.instance;
  ...
  fetchLocalData() async {
    await databaseHelper.getAll(tbl: tableSetup).then((rows) {
      if (rows.isNotEmpty) {
        SetUp.fromJson(rows.last);
      }
    });
  }

  setLang({required String lang}) {
    this.lang = lang;
  }
}
